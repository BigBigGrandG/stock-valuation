...
- Name: frontend\tests\e2e_valuation_integrity.spec.ts >> Real Browser E2E Valuation Integrity (P0/P1) >> browser displays CONFLICT_DEGRADED warning badge and degrades DCF when share conflict occurs
- Location: frontend\tests\e2e_valuation_integrity.spec.ts:97:7
